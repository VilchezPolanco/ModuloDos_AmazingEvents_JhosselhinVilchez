...
// CODIGO DE TARJETAS DINAMICAS
                ...
                <div class="card colorUno" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex flex-column align-items-center">
                        ...
                        <div class="d-flex justify-content-around w-100">
                            <p>$${act.price}</p>
                            <a href="./assets/pages/details.html?_id=${act._id}" class="btn btn-primary">Details</a>
                        </div>
                    </div>
                </div>
            `
    ...
    $cardHome.innerHTML = createCard(data.events)
...
/* SEARCH */
    ...
    $inputSearch.addEventListener ('input', () => { filterCheckboxSearch ()
      ...
      function filterCheckboxSearch(){
        ...
        let runFilterSearch = filterSearch(data.events, $inputSearch.value);
        let runFiltercheckbox = filtercheckbox(runFilterSearch, checkboxChange);
        $cardHome.innerHTML = createCard(runFiltercheckbox)
    }
