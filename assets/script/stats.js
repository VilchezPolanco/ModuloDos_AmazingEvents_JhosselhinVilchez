let $tableOne = document.getElementById("tabla1");
...
//PRIMERA TABLA    
    ...
    function masAsistencia (eventoPast){
        ...
        return eventoMayorAsistencia  //me retorna el evento con mayor asistencia
    }
    ...
    function menorAsistencia (eventoPast){
        ...
        return eventoMenorAsistencia //me retorna el evento con menor asistencia
    }
    ...
    function imprimirPrimeraTabla(){
        ...
        let template= `
            <td class="p-1 text-center">${conMayorAsistencia.name} ${((conMayorAsistencia.assistance*100) / conMayorAsistencia.capacity).toFixed(1)}%</td>
            <td class="p-1 text-center">${conMenorAsistencia.name} ${((conMenorAsistencia.assistance*100) / conMenorAsistencia.capacity).toFixed(2)}%</td>
            <td class="p-1 text-center">${conMasCapacidad.name} ${((conMasCapacidad.capacity).toLocaleString())}</td>
        `
        $tableOne.innerHTML = template  
    }
