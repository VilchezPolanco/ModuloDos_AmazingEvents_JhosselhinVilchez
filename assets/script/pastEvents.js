import{createCheckbox, createCard, filterSearch, filtercheckbox, filterPastEvents}from "../modules/funciones.js"
...
const URL_API = "https://mindhub-xj03.onrender.com/api/amazing"
    ...
    fetch(URL_API)
        ...
        .then(({events, currentDate})=> {
            ...
            data = filterPastEvents(events, currentDate)
           ...
           /*  console.log(createCheckbox(arrayCategory));  */ 
            $cardPast.innerHTML = createCard(data)
        })
